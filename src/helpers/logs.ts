...
type ChalkColors = "green" | "blue" | "red" | "gray" | "greenBright" | "blueBright" | "redBright" | "yellow" | "yellowBright" | "magenta" | "magentaBright";
...
const centeredBox = ({ boxColor, text, inner, outer }: CenteredBoxParams): CLIBox => {
